...
public class TransactionTest {
    ...
    public void shouldComputeNewBalanceAfterWithdrawal() {
        ...
        Transaction transaction = Account.getTransactionBuilder()
                ...
                .withBalance(6000)
                .build();
        assertEquals("The new balance should be 1000 ", 1000.0, transaction.getNewBalance(), 0);
    }
    ...
    public void shouldComputeNewBalanceAfterDeposit() {
        Transaction transaction = Account.getTransactionBuilder()
                ...
                .withBalance(6000)
                .build();
        assertEquals("The new balance should be 11000 ", 11000.0, transaction.getNewBalance(), 0);
    }
}
